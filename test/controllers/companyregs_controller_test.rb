...
class CompanyregsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create companyreg" do
    assert_difference('Companyreg.count') do
      post companyregs_url, params: { companyreg: { : @companyreg., : @companyreg., : @companyreg., : @companyreg., companyid: @companyreg.companyid, companyname: @companyreg.companyname, testdate: @companyreg.testdate, testname: @companyreg.testname } }
    end
  ...
  test "should update companyreg" do
    patch companyreg_url(@companyreg), params: { companyreg: { : @companyreg., : @companyreg., : @companyreg., : @companyreg., companyid: @companyreg.companyid, companyname: @companyreg.companyname, testdate: @companyreg.testdate, testname: @companyreg.testname } }
